...
private:
    using std::enable_shared_from_this<
        PromiseLink<SourceResolveArgumentType, DestinationResolveArgumentType>>::shared_from_this;
...
public:
    ...
    PromiseLink(typename Promise<void>::Pointer promise) : promise_(std::move(promise)) {}

...
namespace channel {
namespace bluetooth {
BluetoothServiceChannel::BluetoothServiceChannel(boost::asio::io_context::strand &strand,
...
void BluetoothServiceChannel::messageHandler(messenger::Message::Pointer message,

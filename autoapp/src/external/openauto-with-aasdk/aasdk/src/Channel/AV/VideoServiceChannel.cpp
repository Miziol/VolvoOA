...
void VideoServiceChannel::sendChannelOpenResponse(const proto::messages::ChannelOpenResponse &response,
...
void VideoServiceChannel::messageHandler(messenger::Message::Pointer message,
...
void VideoServiceChannel::handleStartIndication(const common::DataConstBuffer &payload,
                                                IVideoServiceChannelEventHandler::Pointer eventHandler) {
...
void VideoServiceChannel::handleStopIndication(const common::DataConstBuffer &payload,
                                               IVideoServiceChannelEventHandler::Pointer eventHandler) {

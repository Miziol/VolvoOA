...
int USBWrapper::getConfigDescriptor(libusb_device *dev,
    ...
    config_descriptor_handle = (result == 0 && raw_handle != nullptr)
...
HotplugCallbackHandle USBWrapper::hotplugRegisterCallback(libusb_hotplug_event events,
